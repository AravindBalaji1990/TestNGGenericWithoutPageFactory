...
import elementPage.FirstPageElement;
...
// the locators area assigned as below using By class
//    public static final By btn_graphics = AppiumBy.xpath("//android.widget.TextView[@content-desc=\"Graphics\"]");
    ...
    public void verifyGraphics() {
        boolean data = driver.findElement(FirstPageElement.btn_graphics).isDisplayed();
